...
import {
  ...
  Lightbulb, Settings, LogOut, Menu, X, Users, BarChart3, Bell, UserCircle, TrendingUp, FileSpreadsheet, Waves, Percent
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/cashflow", label: "التدفق النقدي", icon: Waves },
  { href: "/dashboard/vat", label: "تقرير الضريبة", icon: Percent },
